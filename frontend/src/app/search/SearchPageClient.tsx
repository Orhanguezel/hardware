...
function getTypeIcon(articleType: ArticleTypeValue) {
    ...
    switch (t) {
        ...
        case "REVIEW":
            return <SearchIcon className="h-4 w-4 text-green-500" />;
        case "GUIDE":
...
export default function SearchPageClient({ query, type }: SearchPageClientProps) {
    const q = query.trim();
        ...
        return (
            <div className="container py-8">
                <div className="py-12 text-center">
                    ...
                    <h3 className="mb-2 text-xl font-semibold">Arama Yapın</h3>
    ...
    if (isError) {
        return (
            <div className="container py-8">
                <div className="py-12 text-center">
                    <SearchIcon className="mx-auto mb-4 h-16 w-16 text-muted-foreground" />
                    <h3 className="mb-2 text-xl font-semibold">Arama Hatası</h3>
                    <p className="text-muted-foreground">
