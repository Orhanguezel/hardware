  ...
  return (
    <div className="container py-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold mb-2">{transformedArticle.title}</h1>
        {transformedArticle.subtitle && (
          <p className="text-lg text-muted-foreground mb-4">{transformedArticle.subtitle}</p>
        )}
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-1">
            ...
            {new Date(transformedArticle.published_at).toLocaleDateString('tr-TR')}
          </div>
          <div className="flex items-center gap-1">
            <Clock className="w-4 h-4" />
            {new Date(transformedArticle.published_at).toLocaleTimeString('tr-TR', { 
              hour: '2-digit', 
              minute: '2-digit' 
            })}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <CardContent>
              <div 
                ...
                dangerouslySetInnerHTML={{ 
                  __html: typeof transformedArticle.content === 'string' 
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p>{new Date(transformedArticle.published_at).toLocaleDateString('tr-TR')}</p>
              </div>
              <div>
          ...
          {/* Tags */}
          {transformedArticle.article_tags && transformedArticle.article_tags.length > 0 && (
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {transformedArticle.article_tags.map((tag: any) => (
