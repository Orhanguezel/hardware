// scripts/seed-products-django.js

// Bu script Node 18+ (global fetch) varsayıyor.
// Eğer fetch undefined ise Node versiyonunu güncellemen gerekir.

const API_BASE = process.env.DJANGO_API_URL ?? "http://localhost:8000/api";
...
const products = [
  ...
  // Monitör
  {
    ...
    description:
      '49" ultrawide gaming monitör, 240Hz yenileme hızı',
    releaseYear: 2023,
...
async function main() {
  console.log("▶ Ürünler Django API üzerinden oluşturuluyor / güncelleniyor...\n");
