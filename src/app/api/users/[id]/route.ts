...
export async function GET(
  ...
  try {
    ...
    const response = await fetch(`${DJANGO_API_URL}/users/${userId}/profile/`, {
      method: 'GET',
      headers: {
    ...
    const statsResponse = await fetch(`${DJANGO_API_URL}/users/${userId}/stats/public/`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    const user = {
      ...
      profile_visible: userData.privacy_settings?.profile_visible !== false, // Default true
      stats: stats,
